...
class ChickensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chicken" do
    assert_difference("Chicken.count") do
      post chickens_url, params: { chicken: { age: @chicken.age, breed: @chicken.breed, gender: @chicken.gender, name: @chicken.name } }
    end
  ...
  test "should update chicken" do
    patch chicken_url(@chicken), params: { chicken: { age: @chicken.age, breed: @chicken.breed, gender: @chicken.gender, name: @chicken.name } }
